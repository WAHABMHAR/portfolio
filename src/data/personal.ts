...
export const heroStats: StatItem[] = [
  { value: '6', suffix: '+', label: 'Years Experience', description: 'Full-Stack & Mobile Development' },
...
export const quickBioPoints = [
  '6+ years developing high-throughput web (React/Next.js) & mobile applications (React Native/Expo)',
